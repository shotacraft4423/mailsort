...
export const translations = {
  ja: {
    ...
    "dashboard.replyNotNeeded": "返信不要",
    "dashboard.replyNotNeededDone": "「返信不要」として学習しました。",
    ...
    "settings.syncResult": "{count}件の新着メールを取得しました。AIによる自動振り分けが完了するまで、一部は受信箱から他のフォルダ（案件・人材・要返信・重要など）へ自動的に移動することがあります。",
    ...
    "admin.rulesHelp":
      ...
      "「AIに判定させる」条件を使うと、「強いクレームが書かれている」のような一言では表せない基準もAIに判定させられます。" +
      "ルールは自動分類のあとに実行されるため、既定の振り分けより優先されます。並び順（▲▼）は上のルールから順に評価されます。",
    ...
    "admin.editRuleHeading": "ルールを編集",
    "admin.ruleNamePlaceholder": "ルール名",
    "admin.ruleDescriptionPlaceholder": "メモ（任意）: このルールを作った理由など",
    ...
    "admin.aiPromptValuePlaceholder": "判定基準を自由に記述（例: 強いクレームや不満が書かれている）",
    "admin.aiPromptHelp": "「AIに判定させる」条件は、メール1件ごとにAIへ問い合わせて判定します（同じメール・同じ条件文なら再問い合わせしません）。",
    ...
    "admin.addAction": "動作を追加",
    "admin.createRule": "ルール作成",
    "admin.updateRule": "ルールを更新",
  ...
  en: {
    ...
    "dashboard.replyNotNeeded": "No reply needed",
    "dashboard.replyNotNeededDone": "Learned as \"no reply needed\".",
    ...
    "settings.syncResult": "Fetched {count} new message(s). AI auto-sorting may move some of them from Inbox into other folders (Deals, Candidates, Reply Needed, Important, etc.) shortly after sync.",
    ...
    "admin.rulesHelp":
      ...
      "The \"AI judgment\" condition lets you use criteria too fuzzy for a simple match, like \"contains a strong complaint\". " +
      "Rules run after automatic classification, so they take priority over the default routing. Order (▲▼) is evaluated top to bottom.",
    ...
    "admin.editRuleHeading": "Edit rule",
    "admin.ruleNamePlaceholder": "Rule name",
    "admin.ruleDescriptionPlaceholder": "Notes (optional): why this rule exists, etc.",
    ...
    "admin.aiPromptValuePlaceholder": "Describe the judgment call freely (e.g. contains a strong complaint or dissatisfaction)",
    "admin.aiPromptHelp": "An \"AI judgment\" condition asks the AI per message (the same message + condition text is never re-asked).",
    ...
    "ruleField.ai_prompt": "AI judgment",
